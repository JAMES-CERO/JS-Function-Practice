...
// left choice / Follow  
function follow(){
    let thirdAnswer = window.prompt("You follow the cat to a colony of cats, snuggled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven. stay or spread the world? ")
    if (thirdAnswer === "stay") {
        window.alert("You live happily amongst the cats for the rest of your days.")
    } else if (fthirdAnswer === "Spread the world") {
...
//Right choice / away from the dragon
